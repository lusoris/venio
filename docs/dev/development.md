...
|---------|------|--------|---------|----------------|
| 1.0.0 | 2026-01-14 | AI Assistant | Initial development guide | - |

## Referenced Documentation

- **Go Installation:** [Go 1.25 Downloads](https://go.dev/dl/) (Released: 2026-01-10)
- **Docker:** [Docker Engine Documentation](https://docs.docker.com/engine/) (v27.3)
- **golangci-lint:** [golangci-lint Documentation](https://golangci-lint.run/) (v1.61)
- **Air Hot Reload:** [Air GitHub](https://github.com/cosmtrek/air) (v1.52)
- **VSCode Go Extension:** [Go for VS Code](https://marketplace.visualstudio.com/items?itemName=golang.go) (v0.43)
- **Testing in Go:** [Go Testing Package](https://pkg.go.dev/testing)
- **testify:** [testify GitHub](https://github.com/stretchr/testify) (v1.10)
