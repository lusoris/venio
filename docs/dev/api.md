...
|---------|------|--------|---------|----------------|
| 1.0.0 | 2026-01-14 | AI Assistant | Initial API documentation | - |
...
- **bcrypt:** [Go bcrypt Package](https://pkg.go.dev/golang.org/x/crypto/bcrypt)
- **HTTP Status Codes:** [RFC 9110 - HTTP Semantics](https://datatracker.ietf.org/doc/html/rfc9110)
